...
const concepts = [
  {
    ...
    description: "Balanced, architectural, and confidently Islamic.",
    reference: "Wise hierarchy × Islamic architecture",
    colors: ["#123f36", "#b08a45", "#f4efe3"],
    preview: "bg-[#f4efe3] text-[#123f36] font-serif",
  },
  {
    slug: "modern",
    letter: "B",
    title: "Noor Digital",
    description: "High-contrast product clarity with a faith-led core.",
    reference: "Wise progress × Coinbase structure",
    colors: ["#071d19", "#8be1bd", "#f7faf8"],
    preview: "bg-[#071d19] text-white font-sans",
  },
  {
    slug: "editorial",
    letter: "C",
    title: "Modern Manuscript",
    description: "Editorial restraint shaped by Islamic manuscript rhythm.",
    reference: "Revolut focus × illuminated manuscripts",
    colors: ["#172d28", "#9a7134", "#eee7d8"],
    preview: "bg-[#eee7d8] text-[#172d28] font-serif",
  },
  {
    slug: "community",
    letter: "D",
    title: "Amanah Community",
    description: "Warm, mature, and designed around visible accountability.",
    reference: "Revolut selection × community service",
    colors: ["#153e35", "#a17033", "#faf8f2"],
    preview: "bg-[#faf8f2] text-[#153e35] font-sans",
  },
];
