...
- Services menu: same centered rail as the floating nav, white 32px-radius shell, three equal columns, three rows, and a pale-lavender utility link spanning the final two cells.
